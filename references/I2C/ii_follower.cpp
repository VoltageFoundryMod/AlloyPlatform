...
void IIFollower::EnableListen() {
    ...
    I2C4->CR1 |= I2C_CR1_ADDRIE | I2C_CR1_STOPIE | I2C_CR1_NACKIE | I2C_CR1_ERRIE;
}
...
void IIFollower::PrepareQueryResponse(uint8_t cmd) {
    ...
    case II_TUNE:
        ...
        break;
    case II_MOD_DEPTH_1:
        val = state_.mod_depth_1;
        break;
    case II_MOD_DEPTH_2:
        val = state_.mod_depth_2;
        break;
    case II_FREQ_SPREAD:
        val = state_.freq_spread;
        break;
    ...
    case II_BANK:
        val = state_.bank_live;
        break;
    case II_SYNC_1:
        val = state_.sync_1_live;
        break;
    case II_SYNC_2:
        val = state_.sync_2_live;
        break;
    case II_MOD_1:
        val = state_.mod_1_live;
        break;
    case II_MOD_2:
        val = state_.mod_2_live;
        break;
    case II_LFO_1:
        val = state_.lfo_1_live;
        break;
    case II_LFO_2:
        val = state_.lfo_2_live;
        break;
    case II_INTERP:
        val = state_.interp_live;
        break;
    case II_SPREAD_TYPE:
        val = state_.spread_type_live;
        break;
    ...
    // MSB-first
    tx_buf_[0] = static_cast<uint8_t>(
        (static_cast<uint16_t>(val) >> 8) & 0xFF);
    tx_buf_[1] = static_cast<uint8_t>(
        static_cast<uint16_t>(val) & 0xFF);
}
